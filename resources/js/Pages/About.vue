        ...
        <div class="relative min-h-screen items-center justify-center">
            <div class="relative">
                ...
                <main class="pb-20 pt-40">
                    <div
                        class="animate__animated animate__fadeInUp animate__fast animate__delay-0-5s xs:mx-3 sm:mx-5 lg:mx-64"
                    >
                        <div
                            class="mt-6 rounded-lg border-2 border-lime-600/50 bg-slate-50/30 p-5 drop-shadow-md backdrop-blur-lg"
                        >
                            <h1
                                class="text-2xl font-bold transition-all hover:text-lime-600 hover:transition-all"
                            >
                                เกี่ยวกับเรา
                            </h1>
                            <p class="mt-4 text-xl">
                                ในปัจจุบัน ผู้คนให้ความสำคัญกับสุขภาพมากขึ้น
                                โดยเฉพาะด้านโภชนาการ
                                เทคโนโลยีอินเทอร์เน็ตและโซเชียลมีเดียมีบทบาทสำคัญในชีวิตประจำวัน
                                ทำให้พฤติกรรมการค้นหาข้อมูลเกี่ยวกับสุขภาพเปลี่ยนแปลงไป
                                เว็บไซต์ด้านสุขภาพจึงเป็นแหล่งข้อมูลที่สำคัญ
                                แต่หลายเว็บไซต์มักเน้นข้อมูลเชิงลึกและวิชาการ
                                ซึ่งอาจเข้าใจยากและไม่นำไปใช้ได้จริง
                            </p>
                        </div>
                        <div
                            class="mt-6 rounded-lg border-2 border-lime-600/50 bg-slate-50/30 p-5 drop-shadow-md backdrop-blur-lg"
                        >
                            ...
                            <p class="mt-4 text-xl">
                                เรามุ่งมั่นพัฒนา เว็บไซต์แนะนำอาหารเพื่อสุขภาพ
                                ที่เน้นการนำเสนอเนื้อหาเข้าใจง่าย ใช้งานได้จริง
                                และสามารถปรับให้เข้ากับไลฟ์สไตล์ของแต่ละบุคคล
                                เราเชื่อว่าการรับประทานอาหารที่ดีเป็นพื้นฐานของสุขภาพที่แข็งแรง
                                และเราต้องการช่วยให้ทุกคนสามารถเลือกอาหารที่เหมาะสมได้ง่ายขึ้น
                            </p>
                        </div>
                        <div
                            class="mt-6 rounded-lg border-2 border-lime-600/50 bg-slate-50/30 p-5 drop-shadow-md backdrop-blur-lg"
                        >
                            ...
                            <p class="mt-4 text-xl">
                                จากการทดสอบ
                                พบว่าผู้ใช้สามารถเลือกรับประทานอาหารที่เหมาะสมกับร่างกายได้ดีขึ้น
                                โดยคำนึงถึงสารอาหารที่จำเป็น
                                และลดการบริโภคอาหารที่อาจส่งผลเสียต่อสุขภาพ
                            </p>
                        </div>
                    </div>
                </main>
