...
<template>
    ...
    <div class="relative min-h-screen items-center justify-center">
        ...
        >
            <nav
                class="mx-4 my-3 flex items-center justify-between gap-6 rounded-xl border border-black/10 bg-white/50 px-14 py-7 shadow-md backdrop-blur-xl"
            >
        ...
        <main class="overflow-x-hidden pb-20 pt-40 backdrop-blur-sm">
            <div
                class="rounded-lg bg-white/60 p-4 shadow-lg backdrop-blur-lg sm:mx-5 lg:mx-56"
            >
                <h2
                ...
                <div v-if="male_low_musclegain" class="text-xl">
                    ...
                    <p>
                        แม้จะออกกำลังกายน้อย ก็ควรฝึกเวทเบา ๆ 2-3 ครั้ง/สัปดาห์
                    </p>
                    <p>ดื่มน้ำเยอะ ๆ และพักผ่อนให้เพียงพอ</p>
                </div>

                <div v-if="male_moderate1_musclegain" class="text-xl">
                    <p>กินโปรตีน 1.6-2.2 กรัม/กก. และแคลอรีให้เพียงพอ</p>
                    <p>ฝึกเวท 3 ครั้ง/สัปดาห์ + คาร์ดิโอพอเหมาะ</p>
                    <p>
                        เพิ่มน้ำหนัก/จำนวนครั้งเรื่อย ๆ (Progressive Overload)
                    </p>
                    <p>พักผ่อนให้เพียงพอ และดื่มน้ำเยอะ ๆ</p>
                </div>
        ...
        <footer class="w-full cursor-default bg-black px-1 py-16 text-white">
            <div class="sm:mx-5 lg:mx-36">
                ...
                <div class="mt-2 text-left">
                    <p>ผลิตและพัฒนากำลังคนสายอาชีพด้านเทคโนโลยีสารสนเทศ</p>
