        ...
        <div class="relative min-h-screen items-center justify-center">
            <div class="relative">
                ...
                >
                    ...
                    >
                        <div class="flex cursor-default items-center gap-4">
                            <a href="#">
                                <svg
                                    height="33px"
                                    width="33px"
                ...
                <main class="cursor-default pb-20 pt-40 backdrop-blur-sm">
                    <div
                        class="animate__animated animate__fadeInUp animate__fast xs:mx-3 mb-56 mt-32 flex items-center justify-center rounded-lg bg-white/30 py-32 backdrop-blur-lg sm:mx-10 lg:mx-96"
                    >
                        <div class="text-center">
                            <h1
                                class="xs:text-3xl drop-shadow-lg transition-all hover:text-lime-400 hover:transition-all sm:text-3xl md:text-4xl lg:text-5xl"
                            >
                                อาหารเพื่อสุขภาพ
                            </h1>
                            <p
                                class="xs:text-lg mb-6 mt-4 drop-shadow-md sm:text-xl md:text-2xl lg:text-3xl"
                            >
                    ...
                    >
                        <div
                            class="xs:mx-3 mt-24 rounded-lg border-2 border-lime-600/50 bg-slate-50/30 p-5 drop-shadow-md backdrop-blur-lg sm:mx-10 lg:mx-56"
                        >
                            <div class="mx-4 my-2">
                                <h1
                                    class="xs:text-xl transition-all hover:text-lime-800 hover:transition-all sm:text-2xl lg:text-3xl"
                                >
                                    อาหารเพื่อสุขภาพ
                                </h1>
                                <p
                                    class="xs:text-lg mt-2 sm:text-xl lg:text-2xl"
                                >
                                    ...
                                    ร้านอาหาร ที่ทำงาน
                                    และโอกาสรับประทานอาหารอื่นๆ
                                </p>
                                <a
                                    href="#moreinfo1"
                                    class="xs:text-lg mt-2 text-lime-800 underline hover:text-lime-700 sm:text-xl lg:text-2xl"
                                    >ข้อมูลเพื่มเติม</a
                                >
                            </div>
                        </div>
                        <div id="moreinfo1" class="pt-5">
                            <div
                                class="xs:mx-3 mt-24 rounded-lg border-2 border-lime-600/50 bg-slate-50/30 p-5 shadow-md backdrop-blur-lg sm:mx-10 lg:mx-56"
                            >
                                <div class="mx-4 my-2 lg:flex lg:gap-44">
                                    <div>
                                        <h1
                                            class="xs:text-xl transition-all hover:text-lime-600 hover:transition-all sm:text-2xl lg:text-3xl"
                                        >
                        ...
                        >
                            <div class="mx-4 my-2 lg:flex lg:gap-44">
                                ...
                                <div>
                                    <h1
                                        class="xs:text-xl transition-all hover:text-lime-600 hover:transition-all sm:text-left sm:text-2xl lg:text-right lg:text-3xl"
                                    >
                                        อาหารผู้ป่วย
                                    </h1>
                                    <p
                                        class="xs:text-lg mt-2 sm:text-left sm:text-xl lg:text-right lg:text-2xl"
                                    >
                            ...
                            <div class="mx-4 my-2 lg:flex lg:gap-44">
                                <div>
                                    ...
                                    >
                                        ...
                                        เท่าๆ กัน
                                        และแบ่งประเภทอาหารที่จะใส่ลงไปในจานเป็นผัก
                                        2 ส่วน ข้าวหรือ แป้ง 1 ส่วน
                            ...
                            <div class="mx-4 my-2 lg:flex lg:gap-44">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        ช่วยลำเลียงอาหารที่ย่อยแล้วไปยังส่วนต่าง
                                        ๆ และช่วยในการควบคุมอุณหภูมิของร่างกาย
