import { defineComponent, ref, unref, withCtx, createTextVNode, createBlock, openBlock, createVNode, Transition, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderAttr, ssrRenderStyle } from "vue/server-renderer";
import { _ as _imports_0 } from "./bg-5-jMsH0iy3.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isMobile.value) {
        ...
        _push(ssrRenderComponent(unref(Menu), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(MenuButton), { class: "inline-flex w-full justify-center gap-x-1.5 rounded-lg px-3 py-2 text-sm font-semibold text-gray-900 drop-shadow-sm hover:bg-white/40" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16m-7 6h7"${_scopeId2}></path></svg>`);
                  } else {
                    return [
              ...
              _push2(``);
              _push2(ssrRenderComponent(unref(MenuItems), { class: "absolute right-0 z-10 mt-2 w-48 origin-top-right transform rounded-md bg-white/60 py-1 shadow-lg backdrop-blur-md" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                      ...
                      default: withCtx(({ active }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(unref(Link), {
                            href: _ctx.route("Menu"),
                            class: [
                              active ? "bg-gray-100/50 text-black" : "text-black",
              ...
              return [
                createVNode(unref(MenuButton), { class: "inline-flex w-full justify-center gap-x-1.5 rounded-lg px-3 py-2 text-sm font-semibold text-gray-900 drop-shadow-sm hover:bg-white/40" }, {
                  default: withCtx(() => [
                    (openBlock(), createBlock("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      class: "h-6 w-6",
                ...
                createVNode(Transition, {
                  ...
                  default: withCtx(() => [
                    createVNode(unref(MenuItems), { class: "absolute right-0 z-10 mt-2 w-48 origin-top-right transform rounded-md bg-white/60 py-1 shadow-lg backdrop-blur-md" }, {
                      default: withCtx(() => [
                        createVNode(unref(MenuItem), null, {
                          default: withCtx(({ active }) => [
                            createVNode(unref(Link), {
      ...
      _push(`</nav></header><main class="cursor-default pb-20 pt-40 backdrop-blur-sm"><div class="animate__animated animate__fadeInUp animate__fast mb-56 mt-32 flex items-center justify-center rounded-lg bg-white/30 py-32 backdrop-blur-lg sm:mx-10 lg:mx-96"><div class="text-center"><h1 class="drop-shadow-lg transition-all hover:text-lime-400 hover:transition-all sm:text-3xl md:text-4xl lg:text-5xl"> อาหารเพื่อสุขภาพ </h1><p class="mb-6 mt-4 drop-shadow-md sm:text-xl md:text-2xl lg:text-3xl"> ทำแบบทดสอบเพื่อเราสามารถแนะนำอาหารให้ฟรี </p>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("Forms"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="mt-3 h-10 w-44 rounded-lg border border-black/10 bg-gradient-to-r from-green-700/30 to-cyan-700/30 text-center text-xl drop-shadow-xl backdrop-blur-xl transition-all hover:scale-110 hover:border-black/50 hover:transition-all"${_scopeId}> ทำแบบทดสอบ </button>`);
          } else {
            return [
              createVNode("button", { class: "mt-3 h-10 w-44 rounded-lg border border-black/10 bg-gradient-to-r from-green-700/30 to-cyan-700/30 text-center text-xl drop-shadow-xl backdrop-blur-xl transition-all hover:scale-110 hover:border-black/50 hover:transition-all" }, " ทำแบบทดสอบ ")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</div></div><div class="animate__animated animate__fadeInUp animate__fast"><div class="mt-24 rounded-lg border-2 border-lime-600/50 bg-slate-50/30 p-5 drop-shadow-md backdrop-blur-lg sm:mx-10 lg:mx-56"><div class="mx-4 my-2"><h1 class="transition-all hover:text-lime-800 hover:transition-all sm:text-2xl lg:text-3xl"> อาหารเพื่อสุขภาพ </h1><p class="mt-2 sm:text-xl lg:text-2xl"> การรับประทานอาหารเพื่อสุขภาพเริ่มต้นด้วยการเลือกอาหารที่มีประโยชน์ต่อสุขภาพ คุณไม่จำเป็นต้องเป็นเชฟก็สามารถปรุงอาหารที่มีคุณค่าทางโภชนาการและดีต่อสุขภาพหัวใจที่ครอบครัวของคุณจะต้องชื่นชอบได้ เรียนรู้ว่าควรเลือกอาหารประเภทใดในร้านขายของชำ ร้านอาหาร ที่ทำงาน และโอกาสรับประทานอาหารอื่นๆ </p><a href="#moreinfo1" class="mt-2 text-lime-800 underline hover:text-lime-700 sm:text-xl lg:text-2xl">ข้อมูลเพื่มเติม</a></div></div><div id="moreinfo1" class="pt-5"><div class="mt-24 rounded-lg border-2 border-lime-600/50 bg-slate-50/30 p-5 shadow-md backdrop-blur-lg sm:mx-10 lg:mx-56"><div class="mx-4 my-2 lg:flex lg:gap-44"><div><h1 class="transition-all hover:text-lime-600 hover:transition-all sm:text-2xl lg:text-3xl"> อาหารเพื่อสุขภาพหัวใจ </h1><p class="mt-2 sm:text-xl lg:text-2xl"> เรียนรู้ทุกอย่างเกี่ยวกับการรับรองเครื่องหมาย Heart-Check ของสมาคมโรคหัวใจแห่งสหรัฐอเมริกา ซึ่งทำให้ง่ายต่อการระบุอาหารเพื่อสุขภาพหัวใจในร้านขายของชำหรือเมื่อรับประทานอาหารนอกบ้าน </p></div><img src="https://www.heart.org/en/-/media/Healthy-Living-Images/Heart-Check/HCinGroceryStore2.jpg?h=648&amp;iar=0&amp;mw=1910&amp;w=1152&amp;sc_lang=en" alt="Heart-Check Certification" class="h-72 w-96 rounded-lg object-cover shadow-md sm:mx-auto sm:mt-4"></div></div></div><div class="mt-24 rounded-lg border-2 border-lime-600/50 bg-slate-50/30 p-5 shadow-md backdrop-blur-lg sm:mx-10 lg:mx-56"><div class="mx-4 my-2 lg:flex lg:gap-44"><img src="https://s3vmwebprd.s3.ap-southeast-1.amazonaws.com/public/articles/154V9jWgL17oC0qK8GLVJdgCMW8cI1JAAvUELoFD.jpg" alt="Heart-Check Certification" class="mr-36 h-72 w-96 rounded-lg object-cover shadow-md sm:mx-auto sm:mb-4"><div><h1 class="transition-all hover:text-lime-600 hover:transition-all sm:text-left sm:text-2xl lg:text-right lg:text-3xl"> อาหารผู้ป่วย </h1><p class="mt-2 sm:text-left sm:text-xl lg:text-right lg:text-2xl"> เป็นอาหารที่จะช่วยปรับปรุงสภาพร่างกาย และเสริมสร้างภูมิคุ้มกันร่างกายให้กับผู้ป่วยติดเตียง พร้อมกันนั้นยังทำให้ผู้ป่วยได้รับพลังงาน และสารอาหารที่เพียงพอต่อการฟื้นฟูสุขภาพ </p></div></div></div><div class="mt-24 rounded-lg border-2 border-lime-600/50 bg-slate-50/30 p-5 shadow-md backdrop-blur-lg sm:mx-10 lg:mx-56"><div class="mx-4 my-2 lg:flex lg:gap-44"><div><h1 class="transition-all hover:text-lime-600 hover:transition-all sm:text-2xl lg:text-3xl"> 2 : 1 : 1 ลดไขมัน </h1><p class="mt-2 sm:text-xl lg:text-2xl"> 2 : 1 : 1 เป็นการกำหนดปริมาณอาหารที่เหมาะสม โดยการแบ่งสัดส่วนของจาน ออกเป็น 4 ส่วน เท่าๆ กัน และแบ่งประเภทอาหารที่จะใส่ลงไปในจานเป็นผัก 2 ส่วน ข้าวหรือ แป้ง 1 ส่วน และเนื้อสัตว์ 1 ส่วน </p></div><img src="https://www.nestleprofessional.co.th/sites/default/files/2024-08/shutterstock_558298840.jpg" alt="Heart-Check Certification" class="ml-1 h-72 w-96 rounded-lg object-cover object-right shadow-md sm:mx-auto sm:mt-4"></div></div><div class="mt-24 rounded-lg border-2 border-lime-600/50 bg-slate-50/30 p-5 shadow-md backdrop-blur-lg sm:mx-10 lg:mx-56"><div class="mx-4 my-2 lg:flex lg:gap-44"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLLF_UQGkau6iS59nDxUNHcc6zQH_nVK2enShMZEKL4zHNRte_" alt="Heart-Check Certification" class="mr-36 h-72 w-96 rounded-lg object-cover shadow-md sm:mx-auto sm:mb-4"><div><h1 class="transition-all hover:text-lime-600 hover:transition-all sm:text-left sm:text-2xl lg:text-right lg:text-3xl"> ดื่มน้ำ ให้ดีต่อร่างกาย </h1><p class="mt-2 sm:text-left sm:text-xl lg:text-right lg:text-2xl"> น้ำเป็นส่วนประกอบที่สำคัญในร่างกาย เพราะร่างกายมีน้ำเป็นส่วนประกอบกว่าร้อยละ 70 และยังเป็นส่วนประกอบสำคัญของเซลล์ในร่างกาย ช่วยในการนำของเสียออกจากร่างกาย ช่วยลำเลียงอาหารที่ย่อยแล้วไปยังส่วนต่าง ๆ และช่วยในการควบคุมอุณหภูมิของร่างกาย เพราะฉะนั้นการ ดื่มน้ำ เป็นวิธีการสำคัญที่จำเป็นต้องทำ </p></div></div></div></div></main>`);
      if (_ctx.canLogin) {
