...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><img id="background" class="absolute -left-20 top-0 max-w-[877px]" src=""><div class="relative min-h-screen items-center justify-center"><div class="relative w-full"><header class="grid grid-cols-2 items-center gap-2 px-48 py-10 lg:grid-cols-3"><nav><h1 class="text-xl">Good Food</h1></nav></header><main class="mt-6">`);
