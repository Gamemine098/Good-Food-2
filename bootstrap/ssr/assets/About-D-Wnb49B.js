...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h1 class="text-xl underline">เกี่ยวกับเรา</h1>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("Welcome"),
        class: "text-xl transition-colors hover:text-green-400 hover:transition-colors"
      }, {
      ...
      _push(`</div></nav></header><main class="pb-20 pt-40"><div class="mx-64"><div class="mt-6 rounded-lg border-2 border-lime-500 p-5"><h1 class="text-2xl font-bold transition-all hover:text-lime-600 hover:transition-all"> เกี่ยวกับเรา </h1><p class="mt-4 text-xl"> ในปัจจุบัน ผู้คนให้ความสำคัญกับสุขภาพมากขึ้น โดยเฉพาะด้านโภชนาการ เทคโนโลยีอินเทอร์เน็ตและโซเชียลมีเดียมีบทบาทสำคัญในชีวิตประจำวัน ทำให้พฤติกรรมการค้นหาข้อมูลเกี่ยวกับสุขภาพเปลี่ยนแปลงไป เว็บไซต์ด้านสุขภาพจึงเป็นแหล่งข้อมูลที่สำคัญ แต่หลายเว็บไซต์มักเน้นข้อมูลเชิงลึกและวิชาการ ซึ่งอาจเข้าใจยากและไม่นำไปใช้ได้จริง </p></div><div class="mt-6 rounded-lg border-2 border-lime-500 p-5"><h1 class="text-2xl font-bold transition-all hover:text-lime-600 hover:transition-all"> เป้าหมาย </h1><p class="mt-4 text-xl"> เรามุ่งมั่นพัฒนา เว็บไซต์แนะนำอาหารเพื่อสุขภาพ ที่เน้นการนำเสนอเนื้อหาเข้าใจง่าย ใช้งานได้จริง และสามารถปรับให้เข้ากับไลฟ์สไตล์ของแต่ละบุคคล เราเชื่อว่าการรับประทานอาหารที่ดีเป็นพื้นฐานของสุขภาพที่แข็งแรง และเราต้องการช่วยให้ทุกคนสามารถเลือกอาหารที่เหมาะสมได้ง่ายขึ้น </p></div><div class="mt-6 rounded-lg border-2 border-lime-500 p-5"><h1 class="text-2xl font-bold transition-all hover:text-lime-600 hover:transition-all"> ผลการทดสอบ </h1><p class="mt-4 text-xl"> จากการทดสอบ พบว่าผู้ใช้สามารถเลือกรับประทานอาหารที่เหมาะสมกับร่างกายได้ดีขึ้น โดยคำนึงถึงสารอาหารที่จำเป็น และลดการบริโภคอาหารที่อาจส่งผลเสียต่อสุขภาพ </p></div></div></main>`);
      if (_ctx.canLogin) {
