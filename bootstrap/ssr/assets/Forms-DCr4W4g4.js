...
import { ssrRenderComponent, ssrRenderAttr, ssrRenderStyle, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual } from "vue/server-renderer";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 class="text-2xl font-bold"${_scopeId}> Good Food </h1>`);
          } else {
            return [
              createVNode("h1", { class: "text-2xl font-bold" }, " Good Food ")
            ];
          }
        }),
        _: 1
      ...
      _push(`<h1 class="text-xl underline">แบบทดสอบ</h1>`);
      _push(ssrRenderComponent(unref(Link), {
      ...
      _push(`</div></nav></header><main class="pb-20 pt-40 backdrop-blur-sm"><div class="container mx-56 rounded-lg bg-white/60 p-4 shadow-lg backdrop-blur-md"><h2 class="mb-4 text-2xl font-bold">แบบทดสอบ</h2><form><div class="mb-4"><label for="gender" class="block text-sm font-medium text-gray-700">เพศ</label><select id="gender" class="mt-1 block w-32 rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-green-500 focus:outline-none focus:ring-green-500 sm:text-sm" required><option value="" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).gender) ? ssrLooseContain(unref(form).gender, "") : ssrLooseEqual(unref(form).gender, "")) ? " selected" : ""}> กรุณาเลือกเพศ </option><option value="male"${ssrIncludeBooleanAttr(Array.isArray(unref(form).gender) ? ssrLooseContain(unref(form).gender, "male") : ssrLooseEqual(unref(form).gender, "male")) ? " selected" : ""}>ชาย</option><option value="female"${ssrIncludeBooleanAttr(Array.isArray(unref(form).gender) ? ssrLooseContain(unref(form).gender, "female") : ssrLooseEqual(unref(form).gender, "female")) ? " selected" : ""}>หญิง</option></select></div><div class="mb-4"><label for="age" class="block text-sm font-medium text-gray-700">อายุ</label><input type="number" id="age"${ssrRenderAttr("value", unref(form).age)} class="mt-1 block w-44 rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-green-500 focus:outline-none focus:ring-green-500 sm:text-sm" placeholder="กรุณากรอกอายุของคุณ" min="1" required></div><div class="mb-4"><label for="weight" class="block text-sm font-medium text-gray-700">น้ำหนัก</label><input type="number" id="weight"${ssrRenderAttr("value", unref(form).weight)} class="mt-1 block w-48 rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-green-500 focus:outline-none focus:ring-green-500 sm:text-sm" placeholder="กรุณากรอกน้ำหนักของคุณ" min="1" required></div><div class="mb-4"><label for="exercise" class="block text-sm font-medium text-gray-700">ระดับการออกกำลังกายของคุณ</label><select id="exercise" class="mt-1 block w-72 rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-green-500 focus:outline-none focus:ring-green-500 sm:text-sm" required><option value="" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).exercise) ? ssrLooseContain(unref(form).exercise, "") : ssrLooseEqual(unref(form).exercise, "")) ? " selected" : ""}> กรุณาเลือกระดับการออกกำลังกายของคุณ </option><option value="low"${ssrIncludeBooleanAttr(Array.isArray(unref(form).exercise) ? ssrLooseContain(unref(form).exercise, "low") : ssrLooseEqual(unref(form).exercise, "low")) ? " selected" : ""}> น้อย/ไม่ออกกำลังกาย </option><option value="moderate1"${ssrIncludeBooleanAttr(Array.isArray(unref(form).exercise) ? ssrLooseContain(unref(form).exercise, "moderate1") : ssrLooseEqual(unref(form).exercise, "moderate1")) ? " selected" : ""}> ปานกลาง/1-3 ครั้งต่อสัปดาห์ </option><option value="moderate2"${ssrIncludeBooleanAttr(Array.isArray(unref(form).exercise) ? ssrLooseContain(unref(form).exercise, "moderate2") : ssrLooseEqual(unref(form).exercise, "moderate2")) ? " selected" : ""}> ปานกลาง/4-5 ครั้งต่อสัปดาห์ </option><option value="high"${ssrIncludeBooleanAttr(Array.isArray(unref(form).exercise) ? ssrLooseContain(unref(form).exercise, "high") : ssrLooseEqual(unref(form).exercise, "high")) ? " selected" : ""}>มาก/ทุกวัน</option></select></div><div class="mb-4"><label for="goal" class="block text-sm font-medium text-gray-700">เป้าหมาย</label><select id="goal" class="mt-1 block w-56 rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-green-500 focus:outline-none focus:ring-green-500 sm:text-sm" required><option value="" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).goal) ? ssrLooseContain(unref(form).goal, "") : ssrLooseEqual(unref(form).goal, "")) ? " selected" : ""}> กรุณาเลือกเป้าหมายของคุณ </option><option value="muscle_gain"${ssrIncludeBooleanAttr(Array.isArray(unref(form).goal) ? ssrLooseContain(unref(form).goal, "muscle_gain") : ssrLooseEqual(unref(form).goal, "muscle_gain")) ? " selected" : ""}> เพิ่มกล้ามเนื้อ </option><option value="fat_loss"${ssrIncludeBooleanAttr(Array.isArray(unref(form).goal) ? ssrLooseContain(unref(form).goal, "fat_loss") : ssrLooseEqual(unref(form).goal, "fat_loss")) ? " selected" : ""}>ลดไขมัน</option><option value="muscle_maintenance"${ssrIncludeBooleanAttr(Array.isArray(unref(form).goal) ? ssrLooseContain(unref(form).goal, "muscle_maintenance") : ssrLooseEqual(unref(form).goal, "muscle_maintenance")) ? " selected" : ""}> รักษากล้ามเนื้อ </option></select></div><div class="mb-4"><label for="reason" class="block text-sm font-medium text-gray-700">สาเหตุที่รับประทานเพื่อสุขภาพ</label><select id="reason" class="mt-1 block w-72 rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-green-500 focus:outline-none focus:ring-green-500 sm:text-sm" required><option value="" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).reason) ? ssrLooseContain(unref(form).reason, "") : ssrLooseEqual(unref(form).reason, "")) ? " selected" : ""}> กรุณาเลือกสาเหตุที่รับประทานเพื่อสุขภาพ </option><option value="healthy"${ssrIncludeBooleanAttr(Array.isArray(unref(form).reason) ? ssrLooseContain(unref(form).reason, "healthy") : ssrLooseEqual(unref(form).reason, "healthy")) ? " selected" : ""}> เพื่อให้สุขภาพแข็งแรง </option><option value="weight_loss"${ssrIncludeBooleanAttr(Array.isArray(unref(form).reason) ? ssrLooseContain(unref(form).reason, "weight_loss") : ssrLooseEqual(unref(form).reason, "weight_loss")) ? " selected" : ""}> ต้องการลดน้ำหนัก </option><option value="try"${ssrIncludeBooleanAttr(Array.isArray(unref(form).reason) ? ssrLooseContain(unref(form).reason, "try") : ssrLooseEqual(unref(form).reason, "try")) ? " selected" : ""}>อยากลอง</option><option value="influence"${ssrIncludeBooleanAttr(Array.isArray(unref(form).reason) ? ssrLooseContain(unref(form).reason, "influence") : ssrLooseEqual(unref(form).reason, "influence")) ? " selected" : ""}> รับประทานตามคนใกล้ชิด </option></select></div><div class="mb-4"><label for="reason_not_healthy" class="block text-sm font-medium text-gray-700">สาเหตุที่ไม่รับประทานเพื่อสุขภาพ</label><select id="reason_not_healthy" class="mt-1 block rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-green-500 focus:outline-none focus:ring-green-500 sm:text-sm" style="${ssrRenderStyle({ "width": "300px" })}" required><option value="" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).reason_not_healthy) ? ssrLooseContain(unref(form).reason_not_healthy, "") : ssrLooseEqual(unref(form).reason_not_healthy, "")) ? " selected" : ""}> กรุณาเลือกสาเหตุที่ไม่รับประทานเพื่อสุขภาพ </option><option value="taste"${ssrIncludeBooleanAttr(Array.isArray(unref(form).reason_not_healthy) ? ssrLooseContain(unref(form).reason_not_healthy, "taste") : ssrLooseEqual(unref(form).reason_not_healthy, "taste")) ? " selected" : ""}> รสชาติไม่อร่อย </option><option value="hard_to_find"${ssrIncludeBooleanAttr(Array.isArray(unref(form).reason_not_healthy) ? ssrLooseContain(unref(form).reason_not_healthy, "hard_to_find") : ssrLooseEqual(unref(form).reason_not_healthy, "hard_to_find")) ? " selected" : ""}> หารับประทานยาก </option><option value="expensive"${ssrIncludeBooleanAttr(Array.isArray(unref(form).reason_not_healthy) ? ssrLooseContain(unref(form).reason_not_healthy, "expensive") : ssrLooseEqual(unref(form).reason_not_healthy, "expensive")) ? " selected" : ""}>ราคาแพง</option></select></div><div class="mb-4"><label for="health_interest" class="block text-sm font-medium text-gray-700">มีความสนใจในสุขภาพทางด้านใด</label><select id="health_interest" class="mt-1 block w-72 rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-green-500 focus:outline-none focus:ring-green-500 sm:text-sm" required><option value="" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).health_interest) ? ssrLooseContain(unref(form).health_interest, "") : ssrLooseEqual(unref(form).health_interest, "")) ? " selected" : ""}> กรุณาเลือกความสนใจในสุขภาพทางด้านใด </option><option value="exercise"${ssrIncludeBooleanAttr(Array.isArray(unref(form).health_interest) ? ssrLooseContain(unref(form).health_interest, "exercise") : ssrLooseEqual(unref(form).health_interest, "exercise")) ? " selected" : ""}> การออกกำลังกาย </option><option value="healthy_eating"${ssrIncludeBooleanAttr(Array.isArray(unref(form).health_interest) ? ssrLooseContain(unref(form).health_interest, "healthy_eating") : ssrLooseEqual(unref(form).health_interest, "healthy_eating")) ? " selected" : ""}> รับประทานอาหารเพื่อสุขภาพ </option><option value="supplements"${ssrIncludeBooleanAttr(Array.isArray(unref(form).health_interest) ? ssrLooseContain(unref(form).health_interest, "supplements") : ssrLooseEqual(unref(form).health_interest, "supplements")) ? " selected" : ""}> การรับประทานอาหารเสริม </option></select></div><button type="submit" class="rounded-md bg-green-500 px-4 py-2 text-white hover:bg-green-600"> คำนวน </button></form></div></main>`);
      if (_ctx.canLogin) {
        _push(`<footer class="w-full cursor-default bg-black px-1 py-16 text-white"><div class="sm:mx-5 lg:mx-36"><h1 class="text-left text-xl font-bold transition-colors hover:text-red-500 hover:transition-colors"> สาขาวิชาเทคโนโลยีสารสนเทศ </h1><div class="mt-2 text-left"><p> ผลิตและพัฒนากำลังคนสายอาชีพด้านเทคโนโลยีสารสนเทศ </p><p>ให้เป็นกำลังคนที่มีคุณภาพและสมรรถนะสูง</p><p> เพื่อเป็นกำลังหลักสำคัญในการเพิ่มขีดความสามารถในการแข่งขันของประเทศ. </p></div></div><br><div class="mt-3 columns-2 text-right text-sm lg:container sm:mx-5 lg:mx-36"><img src="https://it.cmtc.ac.th/wp-content/uploads/2024/07/logo_footer_itcmtc2024.png" alt="it logo" loading="lazy"><span>Copyright © 2025 สาขาวิชาเทคโนโลยีสารสนเทศ วิทยาลัยเทคนิคเชียงใหม่</span><div class="mt-2">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Forms.vue");
